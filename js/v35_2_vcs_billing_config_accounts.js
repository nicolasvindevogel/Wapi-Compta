...
(function(){
  ...
  function renderAccountSearch(){
    ...
    view.classList.add('w352-account-ready');
  ...
  document.addEventListener('DOMContentLoaded',()=>{renderAccountSearch();setTimeout(async()=>{await loadV352();if(!$('agencyView')?.classList.contains('hidden'))renderConfiguration();if(!$('accountLookupView')?.classList.contains('hidden'))renderAccountSearch();},1200);});
})();
