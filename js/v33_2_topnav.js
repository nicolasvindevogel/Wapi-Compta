...
(() => {
  ...
  function init(){
    ...
    const version = document.createElement('span'); version.className='badge'; version.textContent='V35.5'; document.querySelector('.w332-page-head')?.appendChild(version);
