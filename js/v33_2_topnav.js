...
(() => {
  ...
  function buildTopNavigation(){
    ...
    document.body.dataset.wapiVersion = '34.4';
    document.title = 'WAPI One — V34.4';
  ...
  function init(){
    ...
    const version = document.createElement('span'); version.className='badge'; version.textContent='V34.4'; document.querySelector('.w332-page-head')?.appendChild(version);
